...
**Substrate locked, KERNEL.md constitutional.** These two are glass-factory's
own: the substrate decision is recorded in the issue DB as settled ("not
re-litigated"), and KERNEL.md carries its own amendment rule — an unattended
implementation task is the wrong place to exercise either.
