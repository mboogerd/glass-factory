...
description: Drains glass-factory friction beads at the cheapest total cost — fix the cause, fail loudly, disclose progressively, rarely add skill prose, often close as won't-fix. Use when a work slot or the user asks to resolve frictions, drain the friction log, or improve the work skill.
---
